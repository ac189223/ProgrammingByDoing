...
public class _78_GraphicsDemo2 extends Canvas
{
    public void paint( Graphics g )
    {
        ...
        g.fillArc(150,400,150,150,45,270); // pacman

        g.setColor(Color.pink);
        g.fillArc(300,450,50,50,225,270); // small pacman
        g.setColor(Color.black);
        g.drawArc(300,450,50,50,225,270); // small pacman
        ...
        Color myPink = new Color(214,26,249);
        g.setColor(myPink);
    ...
    public static void main( String[] args )
    {
        ...
        _78_GraphicsDemo2 canvas = new _78_GraphicsDemo2();
        win.add( canvas );
        win.setVisible(true);
    }
}